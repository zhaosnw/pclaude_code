"""Golden-based CLI E2E. Self-contained, rooted at the hare/ package dir.

Each alignment/cases/**/case.json is run through the real CLI subprocess
(e2e_runner.run_case), normalized, and compared to its recorded golden under
alignment/golden/<same-relative-path>/golden.json.
