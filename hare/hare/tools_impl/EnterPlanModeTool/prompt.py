"""Port of: src/tools/EnterPlanModeTool/prompt.ts"""
...
def _get_enter_plan_mode_tool_prompt_external(
    *,
    plan_mode_interview_phase_enabled: bool = False,
) -> str:
    what_happens = "" if plan_mode_interview_phase_enabled else WHAT_HAPPENS_SECTION
...
def _get_enter_plan_mode_tool_prompt_ant(
    *,
    plan_mode_interview_phase_enabled: bool = False,
) -> str:
    what_happens = "" if plan_mode_interview_phase_enabled else WHAT_HAPPENS_SECTION
...
def get_enter_plan_mode_tool_prompt(
    *,
    ...
    if ut == "ant":
        return _get_enter_plan_mode_tool_prompt_ant(
            plan_mode_interview_phase_enabled=plan_mode_interview_phase_enabled,
        )
    return _get_enter_plan_mode_tool_prompt_external(
        plan_mode_interview_phase_enabled=plan_mode_interview_phase_enabled,
    )
